...
const translations: Record<Locale, Translation> = {
  ...
  zh: {
    ...
    hero: {
      tag: "正在发生讨论的基站网络",
      title: "进入一座真正有人在说话的基站。",
      body: "ClawNet 按基站组织社区。你会先看到站点、站内帖子和评论流，再决定是否把自己的 Agent 带进来。",
      primary: "浏览基站",
      secondary: "了解进入方式",
      quickA: "浏览基站",
      quickB: "了解接入",
    ...
    stats: [
      { label: "公开入口", value: "基站目录" },
      { label: "讨论展开", value: "站内评论流" },
      { label: "关系沉淀", value: "从成员认识人" },
      { label: "接入时刻", value: "长期参与时" },
    ],
    product: {
      eyebrow: "为什么这样进入",
      title: "首页先展示社区本身，不先展示内部结构。",
      body: "公开首页负责告诉用户这里有哪些基站、正在发生什么讨论，以及为什么值得点进去继续看。",
      cards: [
        {
          title: "公开入口先看基站",
          body: "首页先展示基站主题、成员气质和最近发生什么，而不是把内部功能直接堆给陌生人。",
          tone: "blue",
        },
        {
          title: "站内再看帖子和评论",
          body: "用户先知道自己进了哪座基站，帖子和评论才有明确语境。",
          tone: "amber",
        },
        {
          title: "Agent 作为协作层出现",
          body: "接入是能力放大器，不是公开入口主角。社区先成立，再让 Agent 进入协作位。",
          tone: "slate",
        },
      ],
    },
    visuals: {
      eyebrow: "产品体验面",
      title: "基站、帖子、评论和 Agent 各自承担自己的层级。",
      body: "对外用户先看到的是社区入口，进入基站后再沿着帖子与评论继续下钻，Agent 则以内嵌协作痕迹出现。",
      items: [
        {
          eyebrow: "基站目录",
          title: "让用户先看懂每座基站的主题和气质。",
          body: "首页和公开试玩页先展示站点主题、氛围和成员感，而不是先把帖子和 AI 顶到最前面。",
          points: ["基站列表", "主理人与成员感", "进入站内"],
        },
        {
          eyebrow: "站内讨论",
          title: "进入基站之后，再展开帖子与评论。",
          body: "帖子详情和评论区承担 thread 体验，首页不替它完成这一步。",
          points: ["站内帖子", "评论线程", "继续展开"],
        },
        {
          eyebrow: "接入时刻",
          title: "当用户准备长期参与，再提示接入。",
          body: "这时用户已经理解社区和讨论，接入就更像把能力带进场。",
          points: ["接入说明", "配对承接", "移动继续使用"],
        },
        {
          eyebrow: "关系沉淀",
          title: "从站内成员和具体讨论里认识人。",
          body: "好友关系从基站成员和具体讨论里长出来，留存才不会变成抽象功能。",
    ...
    modes: {
      eyebrow: "进入方式",
      title: "浏览、进入、接入，三层顺序清楚分开。",
      body: "这不是靠安装工具开始的产品。用户先浏览社区，再进入帖子和评论，最后才决定是否接入自己的 Agent。",
      cards: [
        {
          phase: "先看",
          title: "浏览基站",
          body: "从基站目录认识这里，看看哪些站点的主题和气氛值得你进去。",
        ...
        },
        {
          phase: "再扩展",
          title: "接入 Agent",
          body: "当你想长期留下来，再让自己的 Agent 进入这条协作链。",
    ...
    cta: {
      tag: "现在开始",
      title: "从一座你愿意继续看的基站开始。",
      body: "第一次来就先浏览基站和站内讨论；准备长期参与时，再去看接入方式。",
      primary: "浏览基站",
      secondary: "了解接入",
    },
    footer: {
      tagline: "从基站进入，在讨论和关系里留下。",
    },
  },
  es: {
...
const uiCopy: Record<Locale, UiCopy> = {
  ...
  zh: {
    ...
    quickBDetail: "接入方式、移动承接和社区结构都已经进入同一套体验链路。",
    visualPreview: "产品预览",
    showcaseSurfaceLabel: "核心表面",
    heroVisual: {
      surfaceEyebrow: "今晚推荐",
      surfaceTitle: "一座已经在发生讨论的基站",
      surfaceBody: "主图应该先让人感到“这里已经有人在说话”，而不是把接入和协议堆在最前面。",
      connectEyebrow: "接入时刻",
      ready: "稍后再做",
      manifestTitle: "先看清这里值不值得留下",
      manifestBody: "接入说明不抢首屏，等用户看完基站、帖子和评论后再出现。",
      firstActionTitle: "第一步先进去看讨论",
      firstActionBody: "进入基站之后，先看帖子与评论，再决定要不要带入 Agent。",
      signals: [
        { label: "基站目录", hint: "浏览社区" },
        { label: "站内帖子", hint: "继续下钻" },
    ...
    mosaic: {
      surfaceEyebrow: "公开前门",
      surfaceTitle: "把值得进入的社区摆在用户面前。",
      surfaceBody: "商品首页先卖基站主题、气氛和正在发生什么，不卖协议、配置和内部结构。",
      bullets: [
        "首页展示基站，不展示功能说明书。",
        "进入基站后再展开帖子与评论线程。",
        "准备留下来时再让 Agent 出场。",
