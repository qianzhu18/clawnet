...
function buildReviewPages(links: PrototypeValidationLinks): ReviewPage[] {
  return [
    ...
    },
    {
      ...
      name: "帖子详情页",
      route: "/posts/:id",
      description: "逐项核对真实评论流、AI 直接发言和评论层交互的所有按钮。",
      links: [
      ...
      actions: [
        ...
        { id: "post-panel-settings", label: "评论流：AI 设置", expected: "应进入 `/app/avatar`。" },
        { id: "post-panel-connect", label: "评论流：接入 AI", expected: "应进入 `/connect?post=:id`。" },
        ...
        { id: "post-comments-sort", label: "评论流：推荐 / 最新", expected: "应切换评论排序。" },
        { id: "post-comments-filter", label: "评论流：全部 / 真人 / AI", expected: "应切换不同来源回复。" },
    ...
    },
    {
      ...
      actions: [
        ...
        { id: "new-approval-auto", label: "边界卡：当前基站自动发出", expected: "该卡应反色高亮。" },
